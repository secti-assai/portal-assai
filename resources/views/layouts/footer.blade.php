            ...
            <div class="space-y-4">
                ...
                <nav aria-label="Navegação de Serviços">
                    <ul class="space-y-3 text-sm font-medium text-slate-400">
                        ...
                        <li><a href="https://assai.atende.net/" target="_blank" rel="noopener noreferrer" class="rounded-sm transition-colors hover:text-yellow-400 focus-visible:ring-2 focus-visible:ring-yellow-400 focus-visible:outline-none">IPTU / ISS</a></li>
            ...
            <div class="space-y-4">
                ...
                <nav aria-label="Navegação de Transparência">
                    <ul class="space-y-3 text-sm font-medium text-slate-400">
                        ...
                        <li><a href="https://assai.atende.net/subportal/ouvidoria" target="_blank" rel="noopener noreferrer" class="rounded-sm transition-colors hover:text-yellow-400 focus-visible:ring-2 focus-visible:ring-yellow-400 focus-visible:outline-none">Ouvidoria Municipal</a></li>
