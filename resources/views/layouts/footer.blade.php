        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 mb-12 text-center lg:text-left">
            ...
            <div class="space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="rounded-xl p-2 flex items-center justify-center hover:scale-105 transition-transform cursor-pointer" onclick="showSeloModal('{{ asset('img/selos/selo-diamante.png') }}', 'Selo Diamante de Transparência')" tabindex="0" aria-label="Ver Selo Diamante de Transparência em destaque">
                    ...
                    <div class="rounded-xl p-2 flex items-center justify-center hover:scale-105 transition-transform cursor-pointer" onclick="showSeloModal('{{ asset('img/selos/selo-nacional-compromisso-com-educacao-ouro.png') }}', 'Selo Nacional Compromisso Educação Ouro')" tabindex="0" aria-label="Ver Selo Nacional Compromisso Educação Ouro em destaque">
                    ...
                    <div class="rounded-xl p-2 flex items-center justify-center hover:scale-105 transition-transform cursor-pointer" onclick="showSeloModal('{{ asset('img/selos/icf-certification-badge-assaí-web-200x225.png') }}', 'ICF Certification')" tabindex="0" aria-label="Ver ICF Certification em destaque">
                    ...
                    <div class="rounded-xl p-2 flex items-center justify-center hover:scale-105 transition-transform cursor-pointer" onclick="showSeloModal('{{ asset('img/selos/smart21-logo.jpg') }}', 'Smart 21')" tabindex="0" aria-label="Ver Smart 21 em destaque">
