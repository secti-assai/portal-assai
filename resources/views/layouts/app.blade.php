        ...
        <div class="container flex flex-col items-center justify-between gap-4 mx-auto md:flex-row">
            <div class="flex-1">
                <p class="leading-relaxed">
                    <strong>Aviso de Cookies:</strong> Utilizamos cookies e tecnologias semelhantes para melhorar a sua experiência no portal da Prefeitura Municipal de Assaí, garantindo a segurança e o desempenho do site, em conformidade com a nossa <a href="https://valedosol.assai.pr.gov.br/lgpd" class="font-bold text-yellow-400 underline transition hover:text-yellow-300">Política de Privacidade (LGPD)</a>. Ao continuar navegando, você concorda com estas condições.
                </p>
            </div>
