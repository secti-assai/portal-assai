...
<body class="flex h-screen overflow-hidden font-sans bg-slate-50">
    ...
    <aside class="flex-col hidden w-64 text-white transition-all bg-blue-900 shadow-xl lg:flex shrink-0 z-20">
        ...
        <nav class="flex flex-col flex-1 gap-2 p-4 mt-2 overflow-y-auto">
            ...
            <a href="{{ route('admin.activity-logs.index') }}"
                ...
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4V7m3 10H6a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2z"></path>
                </svg>
                Auditoria
            </a>
    ...
    <div class="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <header class="flex items-center justify-between px-4 md:px-6 py-4 bg-white border-b shadow-sm border-slate-200 shrink-0 z-10">
            <div class="flex items-center gap-4">
                <span class="text-xl font-bold text-slate-800 lg:hidden">Painel Admin</span>
                <details class="lg:hidden relative">
                    <summary class="list-none inline-flex items-center gap-2 px-3 py-2 text-xs font-bold text-blue-900 bg-blue-50 border border-blue-100 rounded-lg cursor-pointer">
                        Menu
                    </summary>
            ...
            <div class="flex items-center gap-3 md:gap-4">
                ...
                <a href="/" target="_blank" class="hidden lg:flex items-center gap-2 px-4 py-2 text-sm font-bold transition rounded-lg text-slate-600 hover:text-blue-600 bg-slate-100 hover:bg-blue-50">
                ...
                <form action="{{ route('logout') }}" method="POST" class="m-0">
                    @csrf
                    <button type="submit" class="inline-flex items-center justify-center gap-2 px-3 md:px-4 py-2 text-sm font-bold text-red-700 transition bg-red-100 rounded-lg hover:bg-red-200 hover:-translate-y-0.5 shadow-sm border border-red-200">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
