    ...
    <form action="{{ route('admin.programas.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-3">
        ...
        <div class="space-y-6 lg:col-span-2">
            <x-admin.panel class="space-y-5">
                ...
                <x-admin.select
                    ...
                    class="bg-slate-50 border-slate-200 focus:bg-white focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all"
                />
            </x-admin.panel>
        </div>
        ...
        <div class="space-y-6">
            ...
            <x-admin.panel title="Visibilidade">
                ...
                <x-admin.checkbox name="destaque" label="Destaque na Página Inicial" color="blue" help-text="Programas marcados como destaque têm prioridade na seção de programas da página inicial, que exibe 3 cards. O limite total é de 3 destaques." />
            </x-admin.panel>
