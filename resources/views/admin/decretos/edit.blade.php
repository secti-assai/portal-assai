...
<div class="flex flex-col gap-6 max-w-4xl mx-auto">
    ...
    <div class="bg-white border border-slate-200 shadow-sm rounded-xl p-6">
        <form action="{{ route('admin.decretos.update', $decreto->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <x-admin.input
                    ...
                    required="true"
                    :value="$decreto->data_publicacao->format('Y-m-d')"
                    class="md:col-span-1"
                />
            </div>
                    ...
                    <div class="mb-4 p-4 bg-blue-50 border border-blue-100 rounded-lg flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <a href="{{ asset('storage/' . $decreto->caminho_local) }}" target="_blank" class="text-xs text-blue-600 hover:underline">Clique para visualizar</a>
                            </div>
                        </div>
