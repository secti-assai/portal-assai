...
@section('content')
    ...
    @can('gerir noticias')
    <a href="{{ route('admin.noticias.create') }}" class="inline-flex items-center justify-start gap-2 rounded-lg border border-blue-200 bg-blue-50 px-4 py-2 text-sm font-semibold text-blue-700 transition hover:bg-blue-600 hover:text-white hover:border-blue-600">
    ...
    @can('gerir eventos')
    <a href="{{ route('admin.eventos.create') }}" class="inline-flex items-center justify-start gap-2 rounded-lg border border-amber-200 bg-amber-50 px-4 py-2 text-sm font-semibold text-amber-700 transition hover:bg-amber-500 hover:text-white hover:border-amber-500">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
        Novo Evento
    </a>
    @endcan
    ...
    @can('gerir servicos')
    <a href="{{ route('admin.servicos.create') }}" class="inline-flex items-center justify-start gap-2 rounded-lg border border-orange-200 bg-orange-50 px-4 py-2 text-sm font-semibold text-orange-700 transition hover:bg-orange-500 hover:text-white hover:border-orange-500">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
        Novo Serviço
    </a>
    @endcan
    ...
    @can('gerir programas')
    <a href="{{ route('admin.programas.create') }}" class="inline-flex items-center justify-start gap-2 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-600 hover:text-white hover:border-emerald-600">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
        Novo Programa
    </a>
    @endcan
    ...
    <a href="{{ route('admin.secretarias.create') }}" class="inline-flex items-center justify-start gap-2 rounded-lg border border-teal-200 bg-teal-50 px-4 py-2 text-sm font-semibold text-teal-700 transition hover:bg-teal-600 hover:text-white hover:border-teal-600">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
        Nova Secretaria
    </a>
    @endcan
    ...
    <div class="grid grid-cols-1 gap-8 mb-8 lg:grid-cols-2">
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
            <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100">
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
            <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100">
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.5a1 1 0 00-1 1v5m0 0H9m4 0h4m-11-2a1 1 0 011-1h1.05a1 1 0 011 1v1a1 1 0 01-1 1H9a1 1 0 01-1-1v-1zm7-4a2 2 0 104 0V8a2 2 0 00-4 0v4z"/></svg>
                    <h2 class="text-base font-bold text-slate-800">Banners Ativos</h2>
                </div>
            ...
            <ul class="divide-y divide-slate-100">
                ...
                <li class="px-6 py-4 hover:bg-slate-50 transition-colors flex items-start gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        @endif
                        <span class="inline-block mt-2 rounded-full bg-indigo-50 text-indigo-700 text-xs font-semibold px-2.5 py-0.5">Ativo</span>
                    </div>
                </li>
                @empty
                <li class="px-6 py-8 text-center text-slate-400 text-sm">
    ...
    {{-- ===== LINHA 5: NOTÍCIAS + EVENTOS + PROGRAMAS ===== --}}
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
            ...
            <ul class="divide-y divide-slate-100">
                ...
                <li class="px-6 py-4 hover:bg-slate-50 transition-colors">
                    ...
                    <p class="text-xs text-slate-400">{{ $programa->created_at->diffForHumans() }}</p>
                </li>
                @empty
                <li class="px-6 py-8 text-center text-slate-400 text-sm">
