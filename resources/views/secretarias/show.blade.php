    ...
    <div class="container px-4 mx-auto max-w-6xl py-10 max-[360px]:py-7">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white border border-slate-300/80 ring-1 ring-slate-200/80 rounded-2xl shadow-[0_10px_24px_rgba(15,23,42,0.12)] hover:shadow-[0_16px_34px_rgba(15,23,42,0.16)] transition-all duration-300 p-8 max-[360px]:p-5">
                    <h2 class="text-lg font-black text-slate-800 mb-5 flex items-center gap-2">
                        <span class="flex items-center justify-center w-8 h-8 bg-blue-700 rounded-lg text-white shadow-sm shrink-0">
                    ...
                    <div class="prose prose-blue max-w-none text-slate-700 leading-relaxed text-sm">
                ...
                <div class="bg-white border border-slate-300/80 ring-1 ring-slate-200/80 rounded-2xl shadow-[0_10px_24px_rgba(15,23,42,0.12)] hover:shadow-[0_16px_34px_rgba(15,23,42,0.16)] transition-all duration-300 p-8 max-[360px]:p-5">
                    ...
                    @if($servicos->isEmpty())
                        <div class="flex flex-col items-center justify-center py-12 text-center bg-slate-100/50 border-2 border-dashed border-slate-200 rounded-xl">
                            ...
                            <p class="text-sm font-medium text-slate-700">Nenhum serviço vinculado a esta secretaria no momento.</p>
                        </div>
                    @else
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach($servicos as $servico)
                                <a href="{{ route('servicos.acessar', $servico->id) }}"
                                   ...
                                   class="flex flex-col items-start p-5 bg-white border border-slate-300/80 ring-1 ring-slate-200/80 rounded-xl hover:shadow-md hover:-translate-y-1 hover:border-blue-300 transition-all duration-200 group">
                                    @php
                                        $iconeBruto = trim((string) ($servico->icone ?? ''));
                                        $temPrefixoFa = \Illuminate\Support\Str::contains($iconeBruto, ['fa-solid', 'fa-regular', 'fa-brands', 'fas', 'far', 'fab', 'fal', 'fad']);
                                        $iconeClasse = '';

                                        if ($iconeBruto !== '') {
                                            if ($temPrefixoFa) {
                                                $iconeClasse = $iconeBruto;
                                            } elseif (\Illuminate\Support\Str::startsWith($iconeBruto, 'fa-')) {
                                    ...
                                    <span class="mt-1.5 inline-flex items-center gap-1 text-xs font-semibold text-slate-700 group-hover:text-blue-600 transition">
                ...
                <div class="lg:sticky lg:top-8 space-y-6">
                    ...
                    <div class="bg-white border border-slate-300/80 ring-1 ring-slate-200/80 rounded-2xl shadow-[0_10px_24px_rgba(15,23,42,0.12)] hover:shadow-[0_16px_34px_rgba(15,23,42,0.16)] transition-all duration-300 overflow-visible pt-16 relative">
                        ...
                        <div class="px-6 pb-6 text-center">
                            <p class="text-xs font-bold uppercase tracking-widest text-slate-600 mb-2">Secretário(a)</p>
                            <p class="text-lg font-black text-slate-800 leading-tight">
                                {{ $secretaria->nome_secretario ?? '—' }}
                            </p>
                            <p class="text-sm text-blue-700 font-semibold mt-4 leading-snug">
                                {{ $secretaria->nome }}
                            </p>
                        </div>
                    </div>
                    ...
                    {{-- Card de Contatos --}}
                    <div class="bg-white border border-slate-300/80 ring-1 ring-slate-200/80 rounded-2xl shadow-[0_10px_24px_rgba(15,23,42,0.12)] hover:shadow-[0_16px_34px_rgba(15,23,42,0.16)] transition-all duration-300 p-6 max-[360px]:p-5">
                        ...
                        <dl class="space-y-4 text-sm">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <dt class="text-xs font-bold uppercase tracking-wide text-slate-600 mb-0.5">Telefone</dt>
                                    <dd>
                            ...
                            @if($secretaria->email)
                            <div class="flex items-start gap-3">
                                <svg class="w-4 h-4 mt-0.5 text-blue-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                <div>
                                    <dt class="text-xs font-bold uppercase tracking-wide text-slate-600 mb-0.5">E-mail</dt>
                                    <dd>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <dt class="text-xs font-bold uppercase tracking-wide text-slate-600 mb-0.5">Endereço</dt>
                    ...
                    {{-- Voltar --}}
                          <a href="{{ route('secretarias.index') }}"
                              class="flex items-center justify-center gap-2 w-full px-4 py-3 text-sm font-bold text-white bg-blue-700 border border-blue-700 rounded-xl hover:bg-blue-800 hover:border-blue-800 transition">
