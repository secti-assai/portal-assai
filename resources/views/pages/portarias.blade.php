...
<section class="pt-24 pb-12 bg-slate-50 min-h-screen" 
    ...
    {{-- Overlay de "Recarregamento" Simulado --}}
    <div x-show="loading" 
        ...
        <div class="flex flex-col items-center">
            <div class="relative">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                    <i class="fa-solid fa-file-invoice text-blue-600 animate-pulse"></i>
                </div>
            </div>
            <p class="mt-4 text-blue-900 font-extrabold tracking-tight animate-pulse uppercase text-xs">Atualizando Portarias...</p>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-10">
            ...
            <p class="text-slate-500">Consulte as portarias oficiais do município de Assaí.</p>
        ...
        <div id="list-container" class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden min-h-[400px]">
             @include('pages.partials.portarias-list')
        </div>
