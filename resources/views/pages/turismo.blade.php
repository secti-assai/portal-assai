...
<section class="py-20 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950 md:py-24 text-white relative overflow-hidden">
    ...
    <div class="container relative z-10 px-4 mx-auto max-w-4xl text-center">
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
            ...
            <a href="{{ route('cidade.nossa-cidade') }}" class="inline-flex items-center gap-2 px-7 py-3 md:py-3.5 font-bold text-white transition border-2 border-white/40 rounded-full hover:border-white hover:bg-white/10 text-sm md:text-base">
