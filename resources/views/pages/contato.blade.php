...
<section class="py-12 bg-blue-900 md:py-16">
    <div class="container px-4 mx-auto max-w-7xl">
        ...
        <h1 class="text-3xl font-extrabold text-white md:text-5xl font-heading">Canais de Atendimento</h1>
        <p class="mt-4 text-lg text-blue-100 max-w-2xl">Encontre os telefones, e-mails oficiais e a localização dos órgãos da Prefeitura Municipal de Assaí.</p>
    </div>
</section>

{{-- ===== CONTATOS E E-MAILS (MOVIDO PARA O TOPO) ===== --}}
<section class="py-12 bg-slate-50 md:py-16">
    <div class="container px-4 mx-auto max-w-7xl">
    ...
    {{-- ── TIER 1: Institucional ── --}}
        <div class="mb-10">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div class="flex flex-col p-6 bg-white border border-yellow-200 rounded-xl hover:shadow-md transition">
                    <div class="flex items-center justify-center w-10 h-10 mb-4 bg-yellow-100 rounded-xl shrink-0">
                        <svg class="w-5 h-5 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Prefeitura Municipal</h3>
                ...
                <div class="flex flex-col p-6 bg-white border border-yellow-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Gabinete do Prefeito</h3>
                ...
                <div class="flex flex-col p-6 bg-white border border-yellow-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Ouvidoria Municipal</h3>
        ...
        <div class="mb-10">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                {{-- Procuradoria Geral --}}
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    <div class="flex items-center justify-center w-10 h-10 mb-4 bg-slate-100 rounded-xl shrink-0">
                        <svg class="w-5 h-5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Procuradoria Geral</h3>
                    ...
                    <div class="flex items-center gap-1.5 mt-2">
                        ...
                        <a href="tel:+554332621313" class="text-sm text-slate-500 hover:text-blue-600 transition-colors">(43) 3262-1313</a>
                    </div>
                </div>
                ...
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Administração e RH</h3>
                ...
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Departamento de Licitação</h3>
        ...
        <div class="mb-2">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    <div class="flex items-center justify-center w-10 h-10 mb-4 bg-blue-50 rounded-xl shrink-0">
                        <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Secretaria de Educação</h3>
                ...
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Secretaria de Saúde</h3>
                ...
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Assistência Social</h3>
                ...
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Agricultura e Meio Ambiente</h3>
                ...
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Secretaria de Finanças</h3>
                ...
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Secretaria de Cultura e Turismo</h3>
                ...
                <div class="flex flex-col p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-1 font-heading">Sec. de Ciência, Tecnologia e Inovação</h3>
    ...
    <div class="container px-4 mx-auto max-w-7xl">
        ...
        <div class="grid grid-cols-1 gap-10 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="p-8 bg-white border border-slate-200 shadow-sm rounded-3xl">
                    <form method="POST" action="{{ route('contato.store') }}" novalidate>
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 mb-5">
                            <div>
                                ...
                                <input
                                    ...
                                    class="w-full px-4 py-3 text-sm text-slate-800 bg-slate-50 border rounded-xl transition focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white {{ $errors->has('nome') ? 'border-red-400 bg-red-50' : 'border-slate-200' }}">
                                @error('nome')
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="w-full px-4 py-3 text-sm text-slate-800 bg-slate-50 border rounded-xl transition focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white {{ $errors->has('email') ? 'border-red-400 bg-red-50' : 'border-slate-200' }}">
                                @error('email')
                                <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input
                                ...
                                class="w-full px-4 py-3 text-sm text-slate-800 bg-slate-50 border rounded-xl transition focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white {{ $errors->has('assunto') ? 'border-red-400 bg-red-50' : 'border-slate-200' }}">
                            @error('assunto')
                            <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea
                                ...
                                class="w-full px-4 py-3 text-sm text-slate-800 bg-slate-50 border rounded-xl resize-none transition focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white {{ $errors->has('mensagem') ? 'border-red-400 bg-red-50' : 'border-slate-200' }}">{{ old('mensagem') }}</textarea>
                            @error('mensagem')
                            <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <button type="submit"
                            class="inline-flex items-center gap-2 px-8 py-3 text-sm font-bold text-white bg-blue-700 rounded-xl hover:bg-blue-800 active:scale-95 transition shadow-sm">
            ...
            <div class="flex flex-col gap-6">
                ...
                {{-- Mapa --}}
                <div class="overflow-hidden rounded-3xl shadow-sm border border-slate-200">
                    <iframe
                ...
                <div class="p-6 bg-white border border-slate-200 rounded-3xl shadow-sm">
                    ...
                    <h3 class="text-base font-bold text-slate-800 font-heading mb-1">Endereço</h3>
                ...
                <div class="p-6 bg-white border border-slate-200 rounded-3xl shadow-sm">
                    ...
                    <h3 class="text-base font-bold text-slate-800 font-heading mb-1">Horário de Atendimento</h3>
                    <p class="text-sm text-slate-500 leading-relaxed">
                        Segunda a Sexta<br>
