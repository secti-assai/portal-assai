...
<main id="conteudo-principal" accesskey="1" tabindex="-1" class="flex flex-col min-h-screen pb-16 bg-gray-50 pt-8">
    <div class="container max-w-4xl px-4 mx-auto font-sans">
        ...
        <article class="p-6 bg-white border border-gray-100 shadow-sm rounded-3xl md:p-12">
            ...
            <header class="mb-8">
                ...
                <h1 class="text-3xl font-black leading-tight text-blue-900 md:text-4xl font-heading mb-4">
                    {{ $noticia->titulo }}
                </h1>

                @if($noticia->resumo)
                    <p class="text-lg text-gray-500 font-medium leading-relaxed border-l-4 border-yellow-400 pl-4">
                        {{ $noticia->resumo }}
                    </p>
                @endif
